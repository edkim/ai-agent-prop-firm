/**
 * Backfill 1 year of daily bars for S&P Technology Sector
 *
 * Usage: npx ts-node backfill-tech-sector-daily.ts
 */
 ...
 */
async function main() {
  console.log('🚀 Starting S&P Tech Sector Daily Data Backfill (1 Year)\n');
  ...
  // Calculate date range (1 year = 365 days)
